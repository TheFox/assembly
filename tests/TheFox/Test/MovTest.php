...
class MovTest extends PHPUnit_Framework_TestCase{
	...
	public function bit32ValueToRegisterProvider(){
		...
		$rv[] = array(0x7fffffff, 'ecx', 'b9ffffff7f');
		$rv[] = array(0x80000000, 'ecx', 'b900000080');
		$rv[] = array(0x80000001, 'ecx', 'b901000080');
		...
		$rv[] = array(0x7fffffff, 'edx', 'baffffff7f');
		$rv[] = array(0x80000000, 'edx', 'ba00000080');
		$rv[] = array(0x80000001, 'edx', 'ba01000080');
		...
		$rv[] = array(0x7fffffff, 'ebx', 'bbffffff7f');
		$rv[] = array(0x80000000, 'ebx', 'bb00000080');
		$rv[] = array(0x80000001, 'ebx', 'bb01000080');
	...
	public function bit64ValueToRegisterProvider(){
		...
		$rv[] = array(0x7f, 'rax', '48c7c07f000000');
		$rv[] = array(0x80, 'rax', '48c7c080000000');
		$rv[] = array(0xff, 'rax', '48c7c0ff000000');
		$rv[] = array(0x100, 'rax', '48c7c000010000');
		$rv[] = array(0x102, 'rax', '48c7c002010000');
		$rv[] = array(0x400, 'rax', '48c7c000040000');
		$rv[] = array(0x47f, 'rax', '48c7c07f040000');
		$rv[] = array(0x1000, 'rax', '48c7c000100000');
		$rv[] = array(0xfffe, 'rax', '48c7c0feff0000');
		$rv[] = array(0xffff, 'rax', '48c7c0ffff0000');
		$rv[] = array(0x10000, 'rax', '48c7c000000100');
		$rv[] = array(0x12345678, 'rax', '48c7c078563412');
		$rv[] = array(0x7ffffffd, 'rax', '48c7c0fdffff7f');
		$rv[] = array((0x7fff << 16) | 0xfffd, 'rax', '48c7c0fdffff7f');
		$rv[] = array(0x7fffffff, 'rax', '48c7c0ffffff7f');
		$rv[] = array((0x7fff << 16) | 0xffff, 'rax', '48c7c0ffffff7f');
		...
		$rv[] = array((0x80000000 << 32), 'rax', '48b80000000000000080');
		$rv[] = array((0xffffffff << 32) | 0xffffffff, 'rax', '48b8ffffffffffffffff');
		
		$rv[] = array(0, 'rcx', '48c7c100000000');
		$rv[] = array(0x7f, 'rcx', '48c7c17f000000');
		$rv[] = array(0x80, 'rcx', '48c7c180000000');
		$rv[] = array(0xff, 'rcx', '48c7c1ff000000');
		$rv[] = array(0x100, 'rcx', '48c7c100010000');
		$rv[] = array(0x102, 'rcx', '48c7c102010000');
		$rv[] = array(0x400, 'rcx', '48c7c100040000');
		$rv[] = array(0x47f, 'rcx', '48c7c17f040000');
		$rv[] = array(0x1000, 'rcx', '48c7c100100000');
		$rv[] = array(0xfffe, 'rcx', '48c7c1feff0000');
		$rv[] = array(0xffff, 'rcx', '48c7c1ffff0000');
		$rv[] = array(0x10000, 'rcx', '48c7c100000100');
		$rv[] = array(0x12345678, 'rcx', '48c7c178563412');
		$rv[] = array(0x7ffffffd, 'rcx', '48c7c1fdffff7f');
		$rv[] = array((0x7fff << 16) | 0xfffd, 'rcx', '48c7c1fdffff7f');
		$rv[] = array(0x7fffffff, 'rcx', '48c7c1ffffff7f');
		$rv[] = array((0x7fff << 16) | 0xffff, 'rcx', '48c7c1ffffff7f');
		$rv[] = array(0x80000000, 'rcx', '48b90000008000000000');
		$rv[] = array(0x80000001, 'rcx', '48b90100008000000000');
		$rv[] = array(0xffffffff, 'rcx', '48b9ffffffff00000000');
		$rv[] = array(0x123456789abcdefe, 'rcx', '48b9fedebc9a78563412');
		$rv[] = array(0x7fffffff00000000, 'rcx', '48b900000000ffffff7f');
		$rv[] = array((0x80000000 << 32), 'rcx', '48b90000000000000080');
		$rv[] = array((0xffffffff << 32) | 0xffffffff, 'rcx', '48b9ffffffffffffffff');
		
		$rv[] = array(0, 'rdx', '48c7c200000000');
		$rv[] = array(0x7f, 'rdx', '48c7c27f000000');
		$rv[] = array(0x80, 'rdx', '48c7c280000000');
		$rv[] = array(0xff, 'rdx', '48c7c2ff000000');
		$rv[] = array(0x100, 'rdx', '48c7c200010000');
		$rv[] = array(0x102, 'rdx', '48c7c202010000');
		$rv[] = array(0x400, 'rdx', '48c7c200040000');
		$rv[] = array(0x47f, 'rdx', '48c7c27f040000');
		$rv[] = array(0x1000, 'rdx', '48c7c200100000');
		$rv[] = array(0xfffe, 'rdx', '48c7c2feff0000');
		$rv[] = array(0xffff, 'rdx', '48c7c2ffff0000');
		$rv[] = array(0x10000, 'rdx', '48c7c200000100');
		$rv[] = array(0x12345678, 'rdx', '48c7c278563412');
		$rv[] = array(0x7ffffffd, 'rdx', '48c7c2fdffff7f');
		$rv[] = array((0x7fff << 16) | 0xfffd, 'rdx', '48c7c2fdffff7f');
		$rv[] = array(0x7fffffff, 'rdx', '48c7c2ffffff7f');
		$rv[] = array((0x7fff << 16) | 0xffff, 'rdx', '48c7c2ffffff7f');
		$rv[] = array(0x80000000, 'rdx', '48ba0000008000000000');
		$rv[] = array(0x80000001, 'rdx', '48ba0100008000000000');
		$rv[] = array(0xffffffff, 'rdx', '48baffffffff00000000');
		$rv[] = array(0x123456789abcdefe, 'rdx', '48bafedebc9a78563412');
		$rv[] = array(0x7fffffff00000000, 'rdx', '48ba00000000ffffff7f');
		$rv[] = array((0x80000000 << 32), 'rdx', '48ba0000000000000080');
		$rv[] = array((0xffffffff << 32) | 0xffffffff, 'rdx', '48baffffffffffffffff');
		
		$rv[] = array(0, 'rbx', '48c7c300000000');
		$rv[] = array(0x7f, 'rbx', '48c7c37f000000');
		$rv[] = array(0x80, 'rbx', '48c7c380000000');
		$rv[] = array(0xff, 'rbx', '48c7c3ff000000');
		$rv[] = array(0x100, 'rbx', '48c7c300010000');
		$rv[] = array(0x102, 'rbx', '48c7c302010000');
		$rv[] = array(0x400, 'rbx', '48c7c300040000');
		$rv[] = array(0x47f, 'rbx', '48c7c37f040000');
		$rv[] = array(0x1000, 'rbx', '48c7c300100000');
		$rv[] = array(0xfffe, 'rbx', '48c7c3feff0000');
		$rv[] = array(0xffff, 'rbx', '48c7c3ffff0000');
		$rv[] = array(0x10000, 'rbx', '48c7c300000100');
		$rv[] = array(0x12345678, 'rbx', '48c7c378563412');
		$rv[] = array(0x7ffffffd, 'rbx', '48c7c3fdffff7f');
		$rv[] = array((0x7fff << 16) | 0xfffd, 'rbx', '48c7c3fdffff7f');
		$rv[] = array(0x7fffffff, 'rbx', '48c7c3ffffff7f');
		$rv[] = array((0x7fff << 16) | 0xffff, 'rbx', '48c7c3ffffff7f');
		$rv[] = array(0x80000000, 'rbx', '48bb0000008000000000');
		$rv[] = array(0x80000001, 'rbx', '48bb0100008000000000');
		$rv[] = array(0xffffffff, 'rbx', '48bbffffffff00000000');
		$rv[] = array(0x123456789abcdefe, 'rbx', '48bbfedebc9a78563412');
		$rv[] = array(0x7fffffff00000000, 'rbx', '48bb00000000ffffff7f');
		$rv[] = array((0x80000000 << 32), 'rbx', '48bb0000000000000080');
		$rv[] = array((0xffffffff << 32) | 0xffffffff, 'rbx', '48bbffffffffffffffff');
